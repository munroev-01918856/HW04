    ...
    $("form").validate({
        ...
        mesages:{
            minX:{
                ...
                min: jQuery.validator.format("Please select  number greater than -51"),
                max: jQuery.validator.format("Please select  number less than 51"),
                integer: jQuery.validator.format("Please select whole number (ex. -1,0,1,2)")  
